...
class _mybodyState extends State<mybody> {
  ...
  void hisstate(){
    if(bmi<18.5){
      _state="Under Normal";
      const resultcolor=Color.fromARGB(255, 116, 171, 220);
    }
    else if(bmi>=18.5 && bmi<25){
      _state="Normal";
      const resultcolor=Color.fromARGB(255, 7, 187, 76);
      
    }
    else if(bmi>=25 && bmi<30){
      _state="Over Weight";
      const resultcolor=Color.fromARGB(255, 209, 178, 1);
    }
    else if(bmi>=30 && bmi<35){
      _state="Obesity Class 1";
      const resultcolor=Color.fromARGB(255, 221, 133, 0);
    }
    else if(bmi>=35 && bmi<40){
      _state="Obesity Class 2";
      const resultcolor=Color.fromARGB(255, 164, 69, 56);
    }
    else if(bmi>=40){
      _state="Obesity Class 3";
      const resultcolor=Color.fromARGB(255, 237, 0, 0);
    }
